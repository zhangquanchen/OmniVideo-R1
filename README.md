...
[![Huggingface](https://img.shields.io/badge/Dataset-Huggingface-yellow)](https://huggingface.co/datasets/jankin123/OmniVideo-R1)
## Instruction
...
<answer>A. Painting a sun on a canvas</answer>
```
